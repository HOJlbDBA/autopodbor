...
<main>
        ...
        <section>
            ...
            <?php  $slide = mysqli_query($link, "SELECT `name` FROM `automobiles` WHERE `popular` = 1");
                ...
                echo "<div>
                        <a href=\"sort.php#{$result['name']}\"><img src=\"img/autom/{$result['name']}.png\"></a><p>{$result['name']}</p><p>Москва</p>
                    </div>";
            }?>
            </div>
        ...
        <div class="block_new_auto">
				<a href="sort.php?price_max=1500000"><div class="cart_new_auto">
                <div class="img_new_auto">
                    <img src="img/autom/econom.jpg" alt="">
                    </div>
                    <div id="t_new_auto"><span id="h_new_auto">Эконом</span><p>до 1,5 млн ₽</p></div> <!-- АвтоПодбор/sort.php?price_max=1500000 -->
            </div></a>
            <a href="sort.php?price_max=3000000"><div class="cart_new_auto">
                <div class="img_new_auto">
                    <img src="img/autom/comfort.jpg" alt="">
                    </div>
                    <div id="t_new_auto"><span id="h_new_auto">Комфорт</span><p>до 3 млн ₽</p></div> <!-- АвтоПодбор/sort.php?price_max=3000000 -->
            </div></a>
            <a href="sort.php?price_max=6000000"><div class="cart_new_auto">
                <div class="img_new_auto">
                    <img src="img/autom/biznes.jpg" alt="">
                    </div>
                    <div id="t_new_auto"><span id="h_new_auto">Бизнес</span><p>до 6 млн ₽</p></div> <!-- АвтоПодбор/sort.php?price_max=6000000 -->
            </div></a>
            <a href="sort.php?price_min=6000000"><div class="cart_new_auto">
                <div class="img_new_auto">
                    <img src="img/autom/premium.jpg" alt="">
                    </div>
                    <div id="t_new_auto"><span id="h_new_auto">Премиум</span><p>от 6 млн ₽</p></div> <!-- АвтоПодбор/sort.php?price_min=6000000 -->
            </div></a>
        </div>
        <h2>НОВОСТИ</h2>
